...
Now you can use the num2curr or num2word function by giving arguments (number,number_system) comma pattern is ignored if number_system argument is given.
This can be used as any other normal function in excel
Examples: 
1) To convert 123456 to currency in indian system(lakhs, crores)  
...
2) To convert 123456 into currency in international system(millions,billions,trillions) 
   Input: =num2curr("123,456.123") (or) =num2curr(123456.123,"international") (or) =num2curr(123456.123,"int")
   Result: One Million Twenty Three Thousand Four Hundred And Fifty Six Rupees Twelve Paise Only
...
Update v1.1:
Supports commas in number and it automatically detects number system from comma pattern.
Example: num2curr("1,22,123") -> One Lakh Twenty Two Thousand One Hundred And Twenty Three Rupees Only
         num2curr("122,123")  -> One Million Twenty Two Thousand One Hundred And Twenty Three Rupees Only
         other comma patterns are ignored.
